...
int main() {
    ...
    cout << "Collision in string hash table is: " << stringTable->collision() << endl;
    cout << "Collision in double hash table is: " << doubleTable->collision() << endl;
    cout << "Collision in checkerboard hash table is: " << table->collision() << endl;
